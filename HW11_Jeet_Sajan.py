...
class Repository:
    ...
    def __init__(self, directory):
        ...
        self.instructor_db_table = pt()
        self.instructor_db_table.field_names = ["CWID", "Name", "Dept", "Course", "Students"]
    ...
    def instructor_table_db(self, db_path):
        """ This function queries the database in db_path inorder to print the Instructors table """
    ...
    def print_tables(self):
        ...
        print(self.instructor_db_table)
...
# main("/Users/jeetsajan/PycharmProjects/SSW810 Assignments/HW11_Jeet_Sajan")
